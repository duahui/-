...
(cl:defclass <DynamicObstacles> (roslisp-msg-protocol:ros-message)
  ((obstacles
    :reader obstacles
    :initarg :obstacles
    :type (cl:vector global_map-msg:DynamicObstacle)
   :initform (cl:make-array 0 :element-type 'global_map-msg:DynamicObstacle :initial-element (cl:make-instance 'global_map-msg:DynamicObstacle))))
)
...
(cl:defmethod cl:initialize-instance :after ((m <DynamicObstacles>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'DynamicObstacles)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name global_map-msg:<DynamicObstacles> is deprecated: use global_map-msg:DynamicObstacles instead.")))

(cl:ensure-generic-function 'obstacles-val :lambda-list '(m))
(cl:defmethod obstacles-val ((m <DynamicObstacles>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader global_map-msg:obstacles-val is deprecated.  Use global_map-msg:obstacles instead.")
  (obstacles m))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <DynamicObstacles>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'obstacles)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'global_map-msg:DynamicObstacle))
