...
(cl:defmethod cl:initialize-instance :after ((m <Obstacles>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Obstacles)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name global_map-msg:<Obstacles> is deprecated: use global_map-msg:Obstacles instead.")))
