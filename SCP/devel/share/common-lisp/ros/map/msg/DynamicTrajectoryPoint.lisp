...
(cl:defmethod cl:initialize-instance :after ((m <DynamicTrajectoryPoint>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'DynamicTrajectoryPoint)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name map-msg:<DynamicTrajectoryPoint> is deprecated: use map-msg:DynamicTrajectoryPoint instead.")))

(cl:ensure-generic-function 'time-val :lambda-list '(m))
(cl:defmethod time-val ((m <DynamicTrajectoryPoint>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader map-msg:time-val is deprecated.  Use map-msg:time instead.")
  (time m))

(cl:ensure-generic-function 'x-val :lambda-list '(m))
(cl:defmethod x-val ((m <DynamicTrajectoryPoint>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader map-msg:x-val is deprecated.  Use map-msg:x instead.")
  (x m))

(cl:ensure-generic-function 'y-val :lambda-list '(m))
(cl:defmethod y-val ((m <DynamicTrajectoryPoint>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader map-msg:y-val is deprecated.  Use map-msg:y instead.")
  (y m))

(cl:ensure-generic-function 'theta-val :lambda-list '(m))
(cl:defmethod theta-val ((m <DynamicTrajectoryPoint>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader map-msg:theta-val is deprecated.  Use map-msg:theta instead.")
  (theta m))
