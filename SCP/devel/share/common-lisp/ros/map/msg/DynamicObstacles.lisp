...
(cl:defclass <DynamicObstacles> (roslisp-msg-protocol:ros-message)
  ((obstacles
    :reader obstacles
    :initarg :obstacles
    :type (cl:vector map-msg:DynamicObstacle)
   :initform (cl:make-array 0 :element-type 'map-msg:DynamicObstacle :initial-element (cl:make-instance 'map-msg:DynamicObstacle))))
)
...
(cl:defmethod cl:initialize-instance :after ((m <DynamicObstacles>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'DynamicObstacles)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name map-msg:<DynamicObstacles> is deprecated: use map-msg:DynamicObstacles instead.")))

(cl:ensure-generic-function 'obstacles-val :lambda-list '(m))
(cl:defmethod obstacles-val ((m <DynamicObstacles>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader map-msg:obstacles-val is deprecated.  Use map-msg:obstacles instead.")
  (obstacles m))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <DynamicObstacles>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'obstacles)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'map-msg:DynamicObstacle))
